...
def run_main_pipeline():
    # directories 
    base_dir = "/scratch/c.c2029098/dementia_ml_project/results/machine_learning/AD_control/neural_network"
    plots_dir = os.path.join(base_dir, "plots")
    auc_dir = os.path.join(base_dir, "AUC")
    for d in (plots_dir, auc_dir): os.makedirs(d, exist_ok=True)

    RAW = "/scratch/c.c2029098/dementia_ml_project/data/processed/ml_data/BDR_AD_control.raw"
    EIG = "/scratch/c.c2029098/dementia_ml_project/results/PCA/BDR_AD_control.eigenvec"
