#!/usr/bin/env python3
# Unpenalised logistic regression using SNPs (AD vs LBD)
import os
import numpy as np
import pandas as pd
...
TEST_SIZE       = 0.2
N_FOLDS         = 10
OUT_DIR         = "/scratch/c.c2029098/dementia_ml_project/results/machine_learning/AD_LBD_snps/logistic_regression/auc"
PRINT_EVERY     = 10
...
def run(df_raw, ev_df, pc_cols, snps, label):
    ...
    for rep in range(N_REPS):
        ...
        # PC adjustment of test probabilities (residualise on PCs)
